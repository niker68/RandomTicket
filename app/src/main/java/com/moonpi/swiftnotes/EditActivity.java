...
public class EditActivity extends AppCompatActivity implements Toolbar.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fontSizeArr = new int[] {14, 22, 30}; // 0 for small, 1 for medium, 2 for large
        fontSizeNameArr = getResources().getStringArray(R.array.fontSizeNames);

        setContentView(R.layout.activity_edit);
        buttonRandomIn = (Button) findViewById(R.id.buttonRandomIn);
    ...
    buttonHome = (Button) findViewById(R.id.buttonHome);
        ...
        buttonRandomIn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Intent intent = new Intent(EditActivity.this, RandomPhraseActivityIn.class);
